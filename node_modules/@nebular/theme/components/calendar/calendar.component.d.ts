 ...
 * */
export declare class NbCalendarComponent {
    /**
     ...
     * */
    dayCellComponent: Type<NbCalendarCell<Date>>;
    /**
     * Custom month cell component. Have to implement `NbCalendarCell` interface.
     * */
    monthCellComponent: Type<NbCalendarCell<Date>>;
    /**
     * Custom year cell component. Have to implement `NbCalendarCell` interface.
     * */
    yearCellComponent: Type<NbCalendarCell<Date>>;
    /**
