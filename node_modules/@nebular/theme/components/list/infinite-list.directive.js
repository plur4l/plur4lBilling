...
var NbInfiniteListDirective = /** @class */ (function () {
    ...
    NbInfiniteListDirective.prototype.ngAfterViewInit = function () {
        ...
        this.scrollService.onScroll()
            .pipe(takeWhile(function () { return _this.alive; }), filter(function () { return _this.windowScroll; }), switchMap(function () { return _this.getContainerDimentions(); }))
        ...
        }), switchMap(function () { return _this.getContainerDimentions(); }))
            .subscribe(function (dimentions) { return _this.checkPosition(dimentions); });
